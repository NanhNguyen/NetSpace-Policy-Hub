...
export default function PolicyCard({ policy, variant = "default" }: PolicyCardProps) {
        ...
        return (
            <div className="policy-card bg-white p-5 rounded-2xl border border-slate-100 flex flex-col justify-between hover:border-primary/30 transition-all hover:shadow-xl hover:shadow-primary/5">
                ...
                <Link
                    ...
                    className="w-full py-2.5 bg-slate-50 border border-slate-100 text-primary font-black rounded-xl hover:bg-primary hover:text-white hover:border-primary transition-all text-xs uppercase tracking-widest text-center block"
                >
                    Chi tiết
                </Link>
            </div>
    ...
    return (
        <div className="policy-card bg-white p-7 rounded-3xl border border-slate-100 shadow-sm flex flex-col justify-between hover:border-primary/20 hover:shadow-2xl hover:shadow-primary/5 transition-all group">
            ...
            <Link
                href={`/policies/${policy.slug}`}
                className="w-full py-3.5 bg-primary border border-primary text-white font-black rounded-2xl hover:bg-primary-dark transition-all text-xs uppercase tracking-[0.15em] text-center block shadow-lg shadow-primary/20 hover:scale-[1.02]"
            >
                Xem quy định
            </Link>
        </div>
